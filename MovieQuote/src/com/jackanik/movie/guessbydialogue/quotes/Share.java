package com.jackanik.movie.guessbydialogue.quotes;
	...
	public static void share(String wish, Context context)
	{
	 ...
	 public static void starthitman(Context c)
	 {
		 Intent intent;
		    ...
		    try {
		        intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.lilait.lordoftherings.topcharracter"));
	 ...
	 public static void startfairytail(Context c)
	 {
		 Intent intent;
		    ...
		    try {
		        intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.sanjib.tvserial.gameofthrones"));
		        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		        c.startActivity(intent);
		    } catch (Exception e) {
