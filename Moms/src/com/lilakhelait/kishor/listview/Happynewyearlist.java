...
public class Happynewyearlist {
	  
	  public static  ArrayList<Wish> newyearsvalues=new ArrayList<Wish>();
	public static ArrayList<Wish> newyearsvalues1=new ArrayList<Wish>();
	public static ArrayList<Wish> sms=new ArrayList<Wish>();
	public static ArrayList<Wish> poems=new ArrayList<Wish>();
	public static ArrayList<Wish> qoutes=new ArrayList<Wish>();
	} 
