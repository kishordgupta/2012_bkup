...
public class MainActivity extends FragmentActivity {
	...
	// Fragments reference
	private CategoryListFragment mStationsFragment;
	private StationListFragment faFragment;
	...
	public static ArrayList<GiftInfo> arrayList=new ArrayList<GiftInfo>();
	public static List<Station> mfavouriteStations ;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mStationsFragment = new CategoryListFragment();
		faFragment=new StationListFragment();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        ...
	        case R.id.sleep:
		           // newGame();
	        	startActivity(new Intent(this, SleepOut.class));
		            return true;
	        case R.id.item3:
	        	mStationsFragment = new CategoryListFragment();
	...
	public class MyPagerAdapter extends FragmentPagerAdapter implements IconTabProvider {
		...
		private final String[] TITLES = { "Channels ", "Currently Playing","Favourite",
				"Web", "Facebook", "Twitter", "Contact" };
		private final int[] iconsimage = { R.drawable.listicon, R.drawable.musicicon,android.R.drawable.star_on,
