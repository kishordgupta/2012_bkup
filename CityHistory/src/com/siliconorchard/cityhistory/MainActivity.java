...
//	private APIFactory apiFactory;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ConstantValues.citynamelist.addAll(DBHelper.getfavouriteset());
		myDbHelper.close();
...
//*/
		...
		if (savedInstanceState == null) {
			...
			// Photos
			//navDrawerItems.add(new NavDrawerItem("Favourite Events", navMenuIcons.getResourceId(2, -1)));
			navDrawerItems.add(new NavDrawerItem("City lists ----", navMenuIcons.getResourceId(0, -1)));
				if(ConstantValues.citynamelist != null)
				{
					for(int i = 0; i < ConstantValues.citynamelist.size(); i++)
					{
						navDrawerItems.add(new NavDrawerItem(ConstantValues.citynamelist.get(i).Cityname, navMenuIcons.getResourceId(1, -1),ConstantValues.citynamelist.get(i).Cityname,true,ConstantValues.citynamelist.get(i).count));
