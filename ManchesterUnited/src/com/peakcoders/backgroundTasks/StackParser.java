...
public class StackParser extends Activity {
	...
	public String url="https://www.facebook.com/manchesterunited/photos_stream";
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     context=this;
				 ...
				 if(GetNetworkStatus.isNetworkAvailable(context))
			           ...
			           pd = ProgressDialog.show(StackParser.this, "Please wait, it will take up to two minute, please let us setup, Working...", "request to server", true, false);
