...
import com.unlock.briefcase.password.TabSample;
...
public class Sponsorpayappstemplate  {
	...
	private String overridingAppId ="20264"; //mAppIdField.getText().toString();
	private String userId = "3";//mUserIdField.getText().toString();
	private String securityToken = "ab99f7bdde38ae92bd7a5250fdac050b";//mSecurityTokenField.getText().toStrin

	
	public Sponsorpayappstemplate(Context c) {
	v=c;	
	User u = new User(c);
	userId=TabSample.deviceId;
	}
