...
public class Sponsorpayappstemplate  {
	...
	private String overridingAppId ="19880"; //mAppIdField.getText().toString();
	private String userId = "3";//mUserIdField.getText().toString();
	private String securityToken = "d9cc1708a4d7f1456c28b2d39c6c584b";//mSecurityTokenField.getText().toStrin

	
	public Sponsorpayappstemplate(Context c) {
	v=c;	
	User u = new User(c);
	userId=SingleToneClass.getInstance().getDeviceInfoList().get(0).getUserId();
	}
