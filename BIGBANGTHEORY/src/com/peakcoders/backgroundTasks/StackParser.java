...
public class StackParser extends Activity {
	...
	public String url="http://www.sheldonsfans.com/thumbs/";
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     context=this;
				 ...
				 if(GetNetworkStatus.isNetworkAvailable(context))
			           ...
			           pd = ProgressDialog.show(StackParser.this, "Please wait, it will take up to two minute, , Working...", "request to server", true, false);
                ...
                String[] pages=page.split("<tr><td v");
                 ...
                 try{
                	...
                	for(int i=0;i<length;i++)
                	{
                		...
                		output.add("http://www.sheldonsfans.com/thumbs/"+search);
                		Log.d("d", "http://www.sheldonsfans.com/thumbs/"+search);
                	}
