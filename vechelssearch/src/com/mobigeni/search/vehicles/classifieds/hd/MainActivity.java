	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// webView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
		 ...
		 webView.getSettings().setPluginsEnabled(true);
			webView.getSettings().setUserAgentString("OneClickOffice App");
		  ...
		  v = new VideoEnabledWebChromeClient(nonVideoLayout, videoLayout, loadingView, webView,c) // See all available constructors...
		   ...
		   webView.setWebViewClient(new WebViewClient() {
		        ...
		        Toast.makeText(c, url+ "Sorry, You need net Connection to get full itemlist", Toast.LENGTH_LONG).show();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			case R.id.exit:
				...
				return true;
		/*	case R.id.boats:
				   webView.loadUrl("http://www.search-vehicles.com/");
				return true;
				case R.id.cartru:
					   webView.loadUrl("http://www.search-vehicles.com/search-vehicles.php?vehicle_type=6001");
					return true;//7f08000f;
					
			       case R.id.moto:
			    	   webView.loadUrl("http://www.search-vehicles.com/browse-motorcycles/");
			    	   return true;//7f08000c;
			       case R.id.Ov:
			    	   webView.loadUrl("http://www.search-vehicles.com/browse-other-vehicles/");
			    	   return true;//7f08000d;
			       case R.id.pp:
			    	   webView.loadUrl("http://www.search-vehicles.com/browse-powersports/");
			    	   return true;//7f08000e;
			      //7f080002;
			       case R.id.races:
			    	   webView.loadUrl("http://www.search-vehicles.com/browse.php");
