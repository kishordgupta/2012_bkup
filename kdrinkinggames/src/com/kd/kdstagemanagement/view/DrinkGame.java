...
import com.kd.kdstagemanagement.list.Drinklevellist;
...
public class DrinkGame extends BaseActivity implements OnClickListener{
	Drinklevellist happynewyearlist=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Drinklevellist.newyearsvalues= Constracttimelist.constructLevel(Helperdata.selectedmovie);
	
		ListView listViewwish = (ListView) findViewById(R.id.list_of_movies);
        happynewyearlist = new Drinklevellist(this);
