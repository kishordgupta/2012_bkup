...
public class FavouriteListAdapter extends BaseAdapter {
	...
	public FavouriteListAdapter(Context context, ArrayList<Vendor> arraylist1) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			S=S+ "\""+arraylist.get(position).getVendorlogo()+"\"" +"alt=\"\"width=\"100%\" height=\"100%\"/></a></body></html>";
				...
				*/
				...
				w.setOnTouchListener(new OnTouchListener() {
					...
					public boolean onTouch(View v, MotionEvent event) {
						...
						//	 MainActivity.loadinwebview(arraylist.get(id).steam,arraylist.get(id).image,arraylist.get(id).radioname);
							 default:
								break;
							}
				...
				fav.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						int id = (Integer) v.getTag();
						//DBHelper.deleteTitle(arraylist.get(id).getVendorname());
						arraylist.remove(id);
