package com.mobigeni.baby.pregnancy.due.countdown.clock;

import com.mobigeni.baby.pregnancy.due.countdown.clock.R;
...
public class MainActivity extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		  ...
		  v = new VideoEnabledWebChromeClient(nonVideoLayout, videoLayout, loadingView, webView,c) // See all available constructors...
		   ...
		   webView.setWebViewClient(new WebViewClient() {
		        ...
		        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
		    	 ...
		    	 //  webView.loadUrl("http://www.gp-live.com/");
		...
		//   webView.loadUrl("http://www.ibaby-app.com/apps/mypregnancy/");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.home:
				...
				return true;
				/*case R.id.a:
					   webView.loadUrl("http://www.search-career.com/search-jobs.php");
					return true;//7f08000f;
					
			       case R.id.b:
			    	   webView.loadUrl("http://www.search-career.com/#categories");
			    	   return true;//7f08000c;
			       case R.id.c:
			    	   webView.loadUrl("http://www.search-career.com/#locations");
