...
public class StackParser extends Activity {
	...
	public String url="https://www.facebook.com/pages/Basic-Ali/118649771502228?id=118649771502228&sk=photos_stream";
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     context=this;
				 ...
				 if(GetNetworkStatus.isNetworkAvailable(context))
			           ...
			           pd = ProgressDialog.show(StackParser.this, "Please wait, it will take up to two minute, like a spawn time, Working...", "request to server", true, false);
