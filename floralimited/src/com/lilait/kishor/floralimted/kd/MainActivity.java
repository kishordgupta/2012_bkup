package com.lilait.kishor.floralimted.kd;


import com.lilait.kishor.floralimted.kd.R;
		 ...
		 webView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
		   ...
		   webView.setWebViewClient(new WebViewClient() {
		        ...
		        //	webView.loadUrl("file:///android_asset/Spun   Just another Caroline Moore site.htm");
		    	    webView.loadUrl("http://www.floralimited.com/");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			case R.id.exit:
				...
				return true;
			case R.id.product:
				 Share.share(webView.getUrl(), this) ;
				return true;
