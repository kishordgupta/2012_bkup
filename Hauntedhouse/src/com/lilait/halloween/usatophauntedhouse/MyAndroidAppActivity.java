...
public class MyAndroidAppActivity extends android.app.TabActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    spec = tabHost.newTabSpec("FirstGroup").setIndicator("Houses",
	    		getResources().getDrawable(R.drawable.moon2)) // Replace null with R.drawable.your_icon to set tab icon
	    				.setContent(intent);
	    tabHost.addTab(spec);
	    ...
	    spec = tabHost.newTabSpec("FirstGroup1").setIndicator("Gallary",
