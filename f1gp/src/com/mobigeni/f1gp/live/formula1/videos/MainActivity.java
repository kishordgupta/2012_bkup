...
import com.mobigeni.f1gp.live.formula1.videos.R;
...
public class MainActivity extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//webView.loadUrl("http://tvserialfreaks.catoom.com/hbo/");
		  //  String s ="http://marsapparel.co.jp/app";
//	 webView.loadUrl("file:///android_asset/CHANEL Bags   Top Brands Bagsfinder.com.htm");
			 //webView.loadUrl("file:///android_asset/Spun   Just another Caroline Moore site.htm");
	//	    AdView a =(AdView)findViewById(R.id.ad);
		//	Toast.makeText(c,a.getHeight()+"_"+a.getWidth(), 5000).show();
webView.loadUrl("http://hscripts.com/scripts/jquery/typing-game/index.php");
		//webView.loadData(getResources().getString(R.string.hello_world),"text/html; charset=UTF-8", null);
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			case R.id.exit:
				...
				return true;
			case R.id.feat:
				   webView.loadUrl("http://www.f1gplive.com/featured/");
				return true;
				case R.id.c13:
					   webView.loadUrl("http://www.f1gplive.com/championship/season-2013/");
					return true;//7f08000f;
					
			       case R.id.cal:
			    	   webView.loadUrl("http://www.f1gplive.com/races/calendar/");
			    	   return true;//7f08000c;
			       case R.id.cerc:
			    	   webView.loadUrl("http://www.f1gplive.com/circuits/");
			    	   return true;//7f08000d;
			       case R.id.championship:
			    	   webView.loadUrl("http://www.f1gplive.com/championship/");
			    	   return true;//7f08000e;
			      //7f080002;
			       case R.id.history:
			    	   webView.loadUrl("http://www.f1gplive.com/inside-f1/history/");
			    	   return true;//7f080015;
			       case R.id.home:
			    	   webView.loadUrl("http://www.f1gplive.com/");
			    	   return true;//7f080004;
			       case R.id.insidemotogp:
			    	   webView.loadUrl("http://www.f1gplive.com/inside-f1/");
			    	   return true;//7f080013;
			       case R.id.inter:
			    	   webView.loadUrl("http://www.f1gplive.com/interviews/");
			    	   return true;//7f080006;
			       case R.id.mov:
			    	   webView.loadUrl("http://www.f1gplive.com/movies/");
			    	   return true;//7f080009;
			       case R.id.news:
			    	   webView.loadUrl("http://www.f1gplive.com/");
			    	   return true;//7f080005;
			       case R.id.onbvideo:
			    	   webView.loadUrl("http://www.f1gplive.com/video/onboard/");
			    	   return true;//7f08000a;
			    	 
			       case R.id.races:
			    	   webView.loadUrl("http://www.f1gplive.com/races/");
			    	   return true;//7f08000b;
			       case R.id.rider:
			    	   webView.loadUrl("http://www.f1gplive.com/team-and-drivers/drivers/");
			    	   return true;//7f080011;
			       case R.id.riderteam:
			    	   webView.loadUrl("http://www.f1gplive.com/team-and-drivers/");
			    	   return true;//7f080010;
			       case R.id.rules:
			    	   webView.loadUrl("http://www.f1gplive.com/inside-f1/rules/");
			    	   return true;//7f080014;
			       case R.id.team:
			    	   webView.loadUrl("http://www.f1gplive.com/team-and-drivers/teams/");
			    	   return true;//7f080012;
			       case R.id.tech://7f080007;
			    	   webView.loadUrl("http://www.f1gplive.com/technical/");
			    	   return true;
			    	  
			       case R.id.vide:
			    	   webView.loadUrl("http://www.f1gplive.com/video/");//7f080008;
			    	   return true;
			/*case R.id.product:
