...
public class killerparser extends Activity {
	...
	public String url="https://graph.facebook.com/Keepcalmandlovedota/photos?type=uploaded&limit=25";
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     context=this;
				 ...
				 if(GetNetworkStatus.isNetworkAvailable(context))
			           ...
			           pd = ProgressDialog.show(killerparser.this, "Working...", "request to server", true, false);
