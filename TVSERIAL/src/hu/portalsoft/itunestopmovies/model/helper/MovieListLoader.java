 ...
 *
 */
public class MovieListLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = MovieListLoader.class.getSimpleName();
	public static final String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	model.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	model.setMovies(modelMovies);
        	//
