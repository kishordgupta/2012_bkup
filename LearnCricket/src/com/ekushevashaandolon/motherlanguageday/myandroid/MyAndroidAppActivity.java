...
public class MyAndroidAppActivity extends android.app.TabActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    spec = tabHost.newTabSpec("FirstGroup").setIndicator(null,
	    		getResources().getDrawable(R.drawable.itihas)) // Replace null with R.drawable.your_icon to set tab icon
	    				.setContent(intent);
	    tabHost.addTab(spec);

            // Create an Intent to launch an Activity for the tab (to be reused)
	    intent = new Intent().setClass(this, FirstGroup1.class);

	    // Initialize a TabSpec for the second tab and add it to the TabHost
	    spec = tabHost.newTabSpec("FirstGroup1").setIndicator("",
	    		getResources().getDrawable(R.drawable.kalponi)) // Replace null with R.drawable.your_icon to set tab icon
	    				.setContent(intent);
	    tabHost.addTab(spec);
	    ...
	    // Initialize a TabSpec for the second tab and add it to the TabHost
	    spec = tabHost.newTabSpec("SecondGroup").setIndicator("",
	    		getResources().getDrawable(R.drawable.vsp6yf)) // Replace null with R.drawable.your_icon to set tab icon
	    				.setContent(intent);
	    tabHost.addTab(spec);
