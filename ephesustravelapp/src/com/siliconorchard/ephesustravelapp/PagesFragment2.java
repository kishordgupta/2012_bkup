...
public class PagesFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pages2, container, false);
		   ...
		   ImageView  button= (ImageView)rootView.findViewById(R.id.streetview);
			MainActivity.im.displayImage("assets://"+image1, button, MainActivity.defaultOptions);
	  		button.setOnClickListener(new OnClickListener() {
			    ...
			    b.setText("Booking");
			    if(ConstantValues.deals_and_discounts_around_ephesus.contains(ConstantValues.CategoryName))
			    	b.setText("Ask for a Free Pick-Up");
			    b.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
							...
							// set title
						Button b =(Button) v;
							alertDialogBuilder.setTitle(b.getText()+"");
							   final String sa= b.getText()+"";
							// set dialog message
							alertDialogBuilder
								.setMessage("Make A Call or email/sms")
								.setCancelable(false)
								.setNegativeButton("Call",new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog, int which) {
										...
										intent.putExtra(Intent.EXTRA_TEXT, ""+ sa);
			    ...
			    ImageView d = (ImageView)rootView.findViewById(R.id.sharethestory1);
			  
				MainActivity.im.displayImage("assets://"+image3, d, MainActivity.defaultOptions);
