package com.mobigeni.search.house.realestate.properties.hd;

import com.mobigeni.search.house.realestate.properties.hd.R;
		  ...
		  v = new VideoEnabledWebChromeClient(nonVideoLayout, videoLayout, loadingView, webView,c) // See all available constructors...
		   ...
		   webView.setWebViewClient(new WebViewClient() {
		        ...
		        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
		    	   ...
		    	   webView.loadUrl("http://www.search-house.com/properties.php");
			...
			case R.id.exit:
				...
				return true;
			       ...
			       case R.id.home:
			           ...
			           case R.id.a:
			             webView.loadUrl("http://www.search-house.com/search.php");return true;//News:>
			                   ...
			                   case R.id.c:
			                     webView.loadUrl("http://www.search-house.com/properties.php?category=timeshares-for-sale");return true;//Ayrton Senna:
			            
			                   case R.id.d:
			                     webView.loadUrl("http://www.search-house.com/properties.php?category=land");return true;//Bruno Senna:>
			            
			       
			    
			           case R.id.e:
			             webView.loadUrl("http://www.search-house.com/properties.php?category=commercial");return true;//Ayrton Senna da Silva:>
			         
			            
			                   case R.id.f:
			                     webView.loadUrl("http://www.search-house.com/properties.php?category=residential");return true;//Personal life:
			              
			            
			                   case R.id.g:
			                     webView.loadUrl("http://www.search-house.com/properties.php?category=other-real-estate");return true;//Early life and career:
