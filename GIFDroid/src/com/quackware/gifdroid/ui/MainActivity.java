...
import com.lilait.youtube.Youubeactivity;
...
public class MainActivity extends Activity implements OnTouchListener {
    ...
    private void setupButtonClickListeners()
    {
    	...
    	((Button)findViewById(R.id.selectyoutube)).setOnTouchListener(this);
    ...
    private void handleClickEvent(View v)
    {
		...
		case R.id.recordVideo:
			...
			break;
		case R.id.selectyoutube:
			Intent  hntent = new Intent(getApplicationContext(),Youubeactivity.class);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			case R.id.viewGallery:
				...
				break;
			case R.id.selectyoutube:
				((Button)findViewById(R.id.selectyoutube)).setBackgroundColor(0xFFFFA500);
				break;
			}
			return true;
		case MotionEvent.ACTION_UP:
			...
			case R.id.viewGallery:
				...
				break;
			case R.id.selectyoutube:
				((Button)findViewById(R.id.selectyoutube)).setBackgroundColor(Color.BLACK);
				handleClickEvent(v);
				break;
			}
