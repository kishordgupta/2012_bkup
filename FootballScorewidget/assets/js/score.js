...
$(function() {
    ...
    $(document).on("mouseup", "#t1 input, #t1s input", function() {
        ...
        calc();
    }).on("change", "#t1ope input.timezone", function() {
        t1load();
    });
});
...
//                "<th>" + a[0] + "</th>" +
                ...
                "<td class='score'><input type='text' maxlength=1 data-team='" + a[3] + "' value='" + sc1 + "' pattern='[0-9]*' class='scorebox1'>" +
                "<input type='text' maxlength=1 data-team='" + a[4] + "' value='" + sc2 + "' pattern='[0-9]*' class='scorebox2'></td>"
                );
//        } else {
        $("#t1").append(
                "<tr>" +
//                "<th>" + a[0] + "</th>" +
                ...
                "<td class='score ctxt'><input type='text' maxlength=1 data-team='" + a[3] + "' value='" + sc1 + "' pattern='[0-9]*'>\uff0d" +
                "<input type='text' maxlength=1 data-team='" + a[4] + "' value='" + sc2 + "' pattern='[0-9]*'>" + "</td>" +
...
t3load = function() {
    ...
    a ? $("#Knockoutstage").attr("href", "knockout.html#!" + e.join("&")).slideDown(200) : $("#Knockoutstage").slideUp(200)
};
calc = function() {
    initteam();
    initrgl();
