...
import com.lilait.bellydance.video.sheik.hot.arab.sanddance.R;
...
public class HomeActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		{
			 Toast.makeText(this, "من فضلك، أعطني بعض الإنترنت", Toast.LENGTH_LONG).show();
			finish();
		}
...
protected void onActivityResult(int requestCode, int resultCode, Intent data) {
	...
	if(requestCode==111)
	{
		...
		{
			 Toast.makeText(this, "Server down  , try after 5 minutes , sorry  ?", Toast.LENGTH_LONG).show();
			finish();
		}
	}
}
