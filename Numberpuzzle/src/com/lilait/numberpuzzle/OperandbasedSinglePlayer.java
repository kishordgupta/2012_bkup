...
public class OperandbasedSinglePlayer {
    ...
    private static final int GAMELEVEL_NORMAL = 1; // can only select operand and can see future operator
    private static final int GAMELEVEL_HARD = 2;   // can only select operand
    ...
    //for easylevel only
    public static int USER_DEFINED_OPERATOR=0;
    
    //for normallevelonly predicted next operator
    public static int NEXT_OPERATOR=0;
