	...
	public class ImageAdapter extends BaseAdapter {
		...
		public View getView( int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				String h = Html.replace("ximgurl", imageUrls[position]).replace("xW", "100%").replace("xH", wh+"");
				
				viewHolder.weView.setBackgroundColor(Color.BLACK);
			//	viewHolder.weView.set//, t, r, b)
				viewHolder.textView	=	(TextView) aView.findViewById(R.id.text_item_cat_desc);
				viewHolder.textView.setText("Click here");
