...
public class Adderparser extends Activity {
	...
	public String url="http://graph.facebook.com/ironman/photos?type=uploaded&limit=25";
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     context=this;
				 ...
				 if(GetNetworkStatus.isNetworkAvailable(context))
			           ...
			           pd = ProgressDialog.show(Adderparser.this, "Working...", "Please wait, it will take up to two minute,please let jervis setup, Working...", true, false);
