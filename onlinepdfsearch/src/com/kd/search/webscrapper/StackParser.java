...
public class StackParser extends Activity {
	...
	public String url="https://itunes.apple.com/search?term="+Helperdata.SearchText.replace(" ","+" )+"&entity="+Helperdata.type;//'//"&q="+Helperdata.SearchText.replace(" ","+" );
    ...
    public class ParseSite extends AsyncTask<String, Void, List<String>> {
        ...
        protected List<String> doInBackground(String... arg) {
            ...
            try 
            {
                ...
                String[] pages=null;
                if(Helperdata.type==Helperdata.type_audiobook)
               pages=page.split("<div class=\"result_c\">");
                if(Helperdata.type==Helperdata.type_ebook)
                    pages=page.split("<div class=\"result_c\">");
                if(Helperdata.type==Helperdata.type_tvShow)
