...
public class Initializeoptions {
	...
	public static void initializesettings(Context con) {
		  ...
		  S1=new Category();
		  S1.tablename="applied_math";
		  S1.viewidd="S1";
		  loadSavedPreferences(S1,true);
		  
		  
		  S2=new Category();
		  S2.tablename="basic_mechanic";
		  S2.viewidd="S2";
		  ...
		  S8=new Category();
		  S8.tablename="fireprotetion";
		  S8.viewidd="S8";
		  loadSavedPreferences(S8);
		  
		  S9=new Category();
		  S9.tablename="environment";
		  S9.viewidd="S9";
		  loadSavedPreferences(S9);
		  
		  S10=new Category();
		  S10.tablename="material";
		  S10.viewidd="S10";
		  loadSavedPreferences(S10);
		  
		  S11=new Category();
		  S11.tablename="Piping";
		  S11.viewidd="S11";
		  loadSavedPreferences(S11);
		  
		  S12=new Category();
		  S12.tablename="boiler";
		  S12.viewidd="S12";
		  loadSavedPreferences(S12);
		  
		  S13=new Category();
		  S13.tablename="Combustion";
		  S13.viewidd="S13";
		  loadSavedPreferences(S13);
		  
		  S14=new Category();
		  S14.tablename="boileroper";
		  S14.viewidd="S14";
		  loadSavedPreferences(S14);
		  
		  S15=new Category();
		  S15.tablename="feedwater";
		  S15.viewidd="S15";
