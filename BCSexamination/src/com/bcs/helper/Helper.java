...
public class Helper {
	...
	public static String getResultComment(int numCorrect, int numRounds, int diff)
	{
		...
		case Constants.EXTREME :
			if (percentage > 90){
				comm="Congratz try www.admissionok.com for more";
				...
				comm="Pathetic! try www.admissionok.com for more";
			}
			break;
  ...
  public static void startweb(Context c)
 {
	 Intent intent;

	    try {
	        intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.admissionok.com"));
