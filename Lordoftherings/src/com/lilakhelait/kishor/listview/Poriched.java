...
public class Poriched extends ArrayAdapter<Wish> {
	  private final Context context;
	  public static  ArrayList<Wish> newyearsvalues=new ArrayList<Wish>();
public int size=0;
Typeface   mFace ;
//public Typeface mFace ;
	  public Poriched(Context context) {
	    super(context, R.layout.list, newyearsvalues);
	    this.context = context;
       this.mFace = Typeface.createFromAsset(context.getAssets(),"bilbobold.ttf");
	//    this.values = values;
		...
		if(wish!=null)
		{
			...
			// Drawable d =null;
			  InputStream ims = null;
				try {
					ims = context.getAssets().open(wish.getImage());
