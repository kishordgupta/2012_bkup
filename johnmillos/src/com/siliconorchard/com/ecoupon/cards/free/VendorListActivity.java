	...
	*/
	private static class APITask extends AsyncTask<Void, Void, String> 
	{
		...
		protected String doInBackground(Void... arg0) 
		{
			try 
			{
				if (InternetConnectivity.isConnectedToInternet(getActivity())) 
				{
					...
					ArrayList<NameValuePair> getcategory = apiFactory.getvendorlist(Instancevalues.currentcategoryname, Instancevalues.currentuser.getUserID(),pageId);
		...
		Log.d("sdf", "2 "+Instancevalues.currentvendorlist.size()+" " );	
				ConstantValues.isBottomReached = true;
				for(int i = 0; i < Instancevalues.currentvendorlist.size(); i++)
				{Log.d("sdf", "3");	
					View item = inflater.inflate(R.layout.vendorfragment, null);
					item.setTag(i);
					
					TextView txtViewKey = (TextView) item.findViewById(R.id.hotelname);
					txtViewKey.setText(Instancevalues.currentvendorlist.get(i).getVendorname());
					
					ImageButton imgbu = (ImageButton)item.findViewById(R.id.mapig);
					imgbu.setTag(i);
					imgbu.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							Intent ia = new Intent(getActivity(),Mapactivity.class);
				...
				/*	TextView txtViewDate = (TextView) item.findViewById(R.id.city);
					txtViewDate.setText(""+Instancevalues.categorylist.get(i).getHotel_address());*/
					
					/*TextView txtViewPoint = (TextView) item.findViewById(R.id.rating);
					txtViewPoint.setText("Star: "+Instancevalues.categorylist.get(i).getHotel_star()+" price :"+ Instancevalues.categorylist.get(i).getPrices_from());
					...
					item.setOnTouchListener( new View.OnTouchListener()
				    {
				        ...
				        case MotionEvent.ACTION_DOWN:
				            ...
				            case MotionEvent.ACTION_UP:
								...
								Instancevalues.lon=Instancevalues.currentvendorlist.get(i).getLon()+"";
								Instancevalues.currentvendor=Instancevalues.currentvendorlist.get(i).getVendorname()+"";
								Intent ia = new Intent(getActivity(),OfferListActivity.class);
