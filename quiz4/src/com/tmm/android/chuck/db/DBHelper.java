...
public class DBHelper extends SQLiteOpenHelper{
	...
	private static String DB_PATH = "/data/data/com.quiz.pretest.exam.s3a1/databases/";
	...
	public List<Question> getQuestionSet(int difficulty, int numQ){
		...
		if(numQ<2)
			numQ=3;
		QueryBuilder.QueryBuilderwhereclause();
		Cursor c = myDataBase.rawQuery("SELECT * FROM all_in_one where " +QueryBuilder.query+
				" ORDER BY RANDOM() LIMIT " + numQ, null);
		Initializeoptions.numberofq=c.getCount();
