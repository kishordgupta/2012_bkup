...
//	private APIFactory apiFactory;
					...
					item.setOnTouchListener( new View.OnTouchListener()
				    {
				        ...
				        case MotionEvent.ACTION_DOWN:
				            ...
				            case MotionEvent.ACTION_UP:
								...
								CitiesActivity.arrayList = new ArrayList<GiftInfo>();
								Urlmaker.urlmaker(Uri.parse(gifttype).toString());
								 new  APITask1(getActivity()).execute();
								if(i%2!=0)
								{
	...
	*/				
		...
		//	LayoutInflater inflater = LayoutInflater.from(getActivity());
			...
			if(arrayList != null)
			{	ca.startActivity(new Intent(ca,CitiesActivity.class));
		/*Log.d("sdf", "size "+arrayList.size()+" " );	
				ConstantValues.isBottomReached = true;
				for(int i = 0; i < arrayList.size(); i++)
				{Log.d("sdf", "view");	
