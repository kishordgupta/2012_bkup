...
import com.happy.thehappypage.fbhappypage.image.wallpaper.glad.R;
	...
	public class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				viewHolder.imageView.getLayoutParams().width = (ConstantValues.DEVICE_WIDTH/2) -2 ;
				viewHolder.imageView.getLayoutParams().height = (int) (((ConstantValues.DEVICE_WIDTH/2)*0.75) -2);
				
				viewHolder.textView	=	(TextView) aView.findViewById(R.id.text_item_cat_desc);
				viewHolder.textView.setText("I am happy because ");
